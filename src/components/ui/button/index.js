...
import Theme, { responsiveHeight, responsiveWidth } from '../../../utils/themeUtils';
...
const Button = (props) => {
  ...
  if (props.btn_xs) {
    ...
    btnContainerStylesArray.push({ height: responsiveHeight(8), paddingHorizontal: 20, paddingVertical: 8 });
    btnTextStylesArray.push({ fontSize: Theme.fontSmall });
  }
  let btnWholeStyles = [];
  btnWholeStyles.push({
  ...
  return (
    <View style={[btnWholeStyles, props.containerStyle, { height: props.height }]}>
      <TouchableOpacity
        style={[btnContainerStylesArray, props.ButtonStyle]}
        rippleContainerBorderRadius={30}
        onPress={props.onPress}>
        <Text style={[btnTextStylesArray, props.textStyle]}>
          {props.text}
        </Text>
      </TouchableOpacity>
    </View>
